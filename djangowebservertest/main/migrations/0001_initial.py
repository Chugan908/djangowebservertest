    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('population', models.IntegerField(db_column='Population')),
                ('countrycode', models.ForeignKey(db_column='CountryCode', on_delete=django.db.models.deletion.DO_NOTHING, to='main.country')),
            ],
            options={
                'db_table': 'city',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('countrycode', models.OneToOneField(db_column='CountryCode', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.country')),
